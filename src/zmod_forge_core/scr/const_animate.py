...
AG_OPEN_DOOR = 12 # 0xC - Nothing
AG_ATTEMPT_OPEN_DOOR = 13 # 0xD - Nothing
AG_UNLOCK_DOOR = 14 # 0xE- N/A
AG_JUMP_WINDOW = 15 # 0xF - N/A
AG_PICKUP_ITEM = 16 # 0x10 - N/A
AG_ATTEMPT_PICKUP = 17 # 0x11 N/A
AG_PICKPOCKET = 18 # 0x12 Failed - will endlesly pickpocket if NPC
AG_ATTACK = 19 # 0x13
AG_ATTEMPT_ATTACK = 20 # 0x14
AG_TALK = 21 # 0x15 Will dialog or shout
AG_PICK_WEAPON = 22 # 0x16  N/A
AG_CHASE = 23 # 0x17    Nothing.
AG_FOLLOW = 24 # 0x18   Will run to target and then back
AG_FOLLOW_TO_LOCATION = 25 # 0x19
AG_FLEE = 26 # 0x1A     Nothing
AG_THROW_SPELL = 27 # 0x1B
AG_ATTEMPT_SPELL = 28 # 0x1C
AG_SHOOT_SPELL = 29 # 0x1D
AG_HIT_BY_SPELL = 30 # 0x1E
AG_HIT_BY_WEAPON = 31 # 0x1F
AG_DODGE = 32 # 0x20 - Dodges nicely
AG_DYING = 33 # 0x21
AG_DESTROY_OBJ = 34 # 0x22
AG_USE_SKILL_ON = 35 # 0x23
AG_ATTEMPT_USE_SKILL_ON = 36 # 0x24 Will kind of give something. Pretty cool.
AG_SKILL_CONCEAL = 37 # 0x25 N/A
...
AG_KNOCKBACK = 45 # 0x2D    Nothing
AG_FLOATING = 46 # 0x2E     Will non-stop moving side to side. anim_goal_interrupt to stop.
AG_CLOSE_DOOR = 47 # 0x2F
AG_ATTEMPT_CLOSE_DOOR = 48 # 0x30
AG_ANIMATE_REVERSE = 49 # 0x31
AG_MOVE_AWAY_FROM_OBJ = 50 # 0x32   Nothing
AG_ROTATE = 51 # 0x33
AG_UNCONCEAL = 52 # 0x34
AG_RUN_NEAR_TILE = 53 # 0x35
AG_RUN_NEAR_OBJ = 54 # 0x36
AG_ANIMATE_STUNNED = 55 # 0x37  Will start hnads up movement like under frog grapple.
AG_ANIMATE_KNEEL_MAGIC_HANDS = 56 # 0x38    Nothing
AG_ATTEMPT_MOVE_NEAR = 57 # 0x39    Nothing
AG_KNOCK_DOWN = 58 # 0x3A   Nothing
AG_ANIM_GET_UP = 59 # 0x3B
AG_ATTEMPT_MOVE_STRAIGHT_KNOCKBACK = 60 # 0x3C  Crash
AG_WANDER = 61 # 0x3D   Endlessly loop.
AG_WANDER_SEEK_DARKNESS = 62 # 0x3E
AG_USE_PICKLOCK_SKILL_ON = 63 # 0x3F    Will do animation with sound.
AG_PLEASE_MOVE = 64 # 0x40  Will go near tile.
AG_ATTEMPT_SPREAD_OUT = 65 # 0x41   Run to near tile to target.
...
AG_BACK_OFF_FROM = 79 # 0x4F    Nothing
AG_ATTEMPT_USE_PICKPOCKET_SKILL_ON = 80 # 0x50  Nothing
