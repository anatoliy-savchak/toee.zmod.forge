class PyObjHandle(object):
	...
	def find_path_to_obj(self, target, flags = None):
		"""npc.find_path_to_obj(PyObjHandle: target, int: flags) -> tpdp.LocAndOffsets"""
		return object()
	...
	def obj_set_float(self, field, value):
		"""Set internal field float value. npc.obj_set_float(int[obj_f_*]: field, float: value) -> None"""
		return
...
obj_f_pad_i64_3 = 67
obj_f_pad_i64_4 = 68
obj_f_last_hit_by = 69 # Obj
obj_f_pad_obj_1 = 70 # Obj
obj_f_pad_obj_2 = 71 # Obj
obj_f_pad_obj_3 = 72 # Obj
obj_f_pad_obj_4 = 73 # Obj
...
obj_f_critter_fleeing_from = 306	# Obj
...
obj_f_npc_combat_focus = 357	# Obj
